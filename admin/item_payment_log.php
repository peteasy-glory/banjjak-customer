...
<script>
	...
	$(document).on("click", "#admin_item_payment_log .go_item_payment_detail_btn", function(){
		...
		location.href = '<?=$admin_directory?>/item_payment_log_detail.php?no='+order_num+'&backurl='+encodeURIComponent(window.location.pathname+"?os="+search_order_status+"&ps="+search_pay_status+"&il="+search_item_list+"&cn="+search_customer_name);
	});

	$(document).on("click", ".old_item_payment_log_btn", function(){
