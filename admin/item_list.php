		...
		success: function(data) {
			if(data.code == "000000"){
				...
				$.each(data.data.list, function(i, v){
					...
					var is_view_main_3 = (v.is_view_main_3 == "1")? "<span class='view_tag'>쇼핑MD(강아지)</span>" : "";
					var is_view_main_4 = (v.is_view_main_4 == "1")? "<span class='view_tag'>쇼핑NEW(강아지)</span>" : "";
					var is_view_main_5 = (v.is_view_main_5 == "1")? "<span class='view_tag'>베스트(강아지)</span>" : "";
					var is_view_main_6 = (v.is_view_main_6 == "1")? "<span class='view_tag'>인기</span>" : "";
					var is_view_main_7 = (v.is_view_main_7 == "1")? "<span class='view_tag'>쇼핑MD(고양이)</span>" : "";
					var is_view_main_8 = (v.is_view_main_8 == "1")? "<span class='view_tag'>쇼핑NEW(고양이)</span>" : "";
					var is_view_main_9 = (v.is_view_main_9 == "1")? "<span class='view_tag'>베스트(고양이)</span>" : "";
