            ...
            $sql = "
                SELECT * FROM (
                    SELECT a.*, 
                            ...
                            AND is_shop = '2' AND is_delete = '1') cnt
    ...
    // 카테고리별 상품리스트 가져오기
        ...
        if ($category) {
            ...
            $cnt_sql = "
                ...
                AND is_shop = '2' AND is_delete = '1' AND is_view = '1'
            ";
            ...
            $sql = "
                ...
                AND a.is_shop = '2' AND a.is_delete = '1' AND a.is_view = '1' ORDER BY a.is_soldout, a.reg_dt DESC
                LIMIT " . $limit . ", 20
            ";
            $array = sql_fetch_array($sql);
