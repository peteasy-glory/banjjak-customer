<?php
	...
	if($r_mode){
		if($r_mode == "get_item_list"){							// 0001 상품리스트 가져오기
			...
			$r_search_sold	   = ($_POST["search_sold"] && $_POST["search_sold"] != "")? $_POST["search_sold"] : "";
			$r_search_ivm1	   = ($_POST["search_ivm1"] && $_POST["search_ivm1"] != "")? $_POST["search_ivm1"] : "";
			$r_category		   = ($_POST["category"] && $_POST["category"] != "")? $_POST["category"] : "";
			$r_is_view_main_1  = ($_POST["is_view_main_1"] && $_POST["is_view_main_1"] != "")? $_POST["is_view_main_1"] : "";
			$r_is_view_main_2  = ($_POST["is_view_main_2"] && $_POST["is_view_main_2"] != "")? $_POST["is_view_main_2"] : "";
			$r_is_view_main_3  = ($_POST["is_view_main_3"] && $_POST["is_view_main_3"] != "")? $_POST["is_view_main_3"] : "";
			$r_is_view_main_4  = ($_POST["is_view_main_4"] && $_POST["is_view_main_4"] != "")? $_POST["is_view_main_4"] : "";
			$r_is_view_main_5  = ($_POST["is_view_main_5"] && $_POST["is_view_main_5"] != "")? $_POST["is_view_main_5"] : "";
			$r_is_view_main_6  = ($_POST["is_view_main_6"] && $_POST["is_view_main_6"] != "")? $_POST["is_view_main_6"] : "";
			$r_is_view_main_7  = ($_POST["is_view_main_7"] && $_POST["is_view_main_7"] != "")? $_POST["is_view_main_7"] : "";
			$r_is_view_main_8  = ($_POST["is_view_main_8"] && $_POST["is_view_main_8"] != "")? $_POST["is_view_main_8"] : "";
			$r_is_view_main_9  = ($_POST["is_view_main_9"] && $_POST["is_view_main_9"] != "")? $_POST["is_view_main_9"] : "";
			$r_is_shop		   = ($_POST["is_shop"] && $_POST["is_shop"] != "")? $_POST["is_shop"] : "";
			...
			$r_limit_all	   = ($_POST["limit_all"] && $_POST["limit_all"] != "")? $_POST["limit_all"] : "";
			$r_orderby		   = ($_POST["orderby"] && $_POST["orderby"] != "")? $_POST["orderby"] : "";
			$customer_search_item = ($_POST["customer_search_item"] && $_POST["customer_search_item"] != "")? $_POST["customer_search_item"] : "";
			$img_list = "";
			$where_qy = "";
			$order_qy = "";
			$limit_qy = "";
			...
			$r_product_no	   = ($_POST["product_no"] && $_POST["product_no"] != "")? $_POST["product_no"] : "";
			$r_is_shop		   = ($_POST["is_shop"] && $_POST["is_shop"] != "")? $_POST["is_shop"] : "2"; // 전문몰상품여부(1-전문몰,2-반짝몰)
			...
			$r_order_num	   = ($_POST["order_num"] && $_POST["order_num"] != "")? $_POST["order_num"] : "";
			$r_order_status	   = ($_POST["order_status"] && $_POST["order_status"] != "")? $_POST["order_status"] : "";
			...
			$r_is_review	   = ($_POST["is_review"] && $_POST["is_review"] != "")? $_POST["is_review"] : "";
			$r_is_shop		   = ($_POST["is_shop"] && $_POST["is_shop"] != "")? $_POST["is_shop"] : "";
			$r_ip_seq		   = ($_POST["ip_seq"] && $_POST["ip_seq"] != "")? $_POST["ip_seq"] : "";
			$r_flag			   = ($_POST["flag"] && $_POST["flag"] != "")? $_POST["flag"] : "0";
			...
			*/
			...
			$r_product_no = ($_POST["product_no"] && $_POST["product_no"] != "")? $_POST["product_no"] : "";
			$r_customer_id = ($_POST["customer_id"] && $_POST["customer_id"] != "")? $_POST["customer_id"] : "";
			$r_iplp_seq = ($_POST["iplp_seq"] && $_POST["iplp_seq"] != "")? $_POST["iplp_seq"] : "";
			$where_qy = "";
			...
			$r_iplp_seq			= ($_POST["iplp_seq"] && $_POST["iplp_seq"] != "")? $_POST["iplp_seq"] : "";
			$r_order_num		= ($_POST["order_num"] && $_POST["order_num"] != "")? $_POST["order_num"] : "";
			$r_kakao_type		= ($_POST["kakao_type"] && $_POST["kakao_type"] != "")? $_POST["kakao_type"] : "";
