...
<script>
	...
	function item_html(){
		return new Promise(function(resolve, reject) {
			...
			html += '		<div class="flex-item '+is_checked+'" data-category="31n82"><h5 class="menu_name">미용/관리</h5></div>';
			html += '	</div>';
			var is_checked = (category == "32n83")? " on " : "";
			html += '	<div class="item_menu">';
			html += '		<div class="flex-item '+is_checked+'" data-category="32n83"><h5 class="menu_name">목욕용품</h5></div>';
			html += '	</div>';
			var is_checked = (category == "29n84")? " on " : "";
			html += '	<div class="item_menu">';
			html += '		<div class="flex-item '+is_checked+'" data-category="29n84"><h5 class="menu_name">위생용품</h5></div>';
			html += '	</div>';
			var is_checked = (category == "30n81")? " on " : "";
			html += '	<div class="item_menu">';
			html += '		<div class="flex-item '+is_checked+'" data-category="30n81"><h5 class="menu_name">칫솔/치약</h5></div>';
			html += '	</div>';
			var is_checked = (category == "50n99")? " on " : "";
			html += '	<div class="item_menu">';
			html += '		<div class="flex-item '+is_checked+'" data-category="50n99"><h5 class="menu_name">건강관리</h5></div>';
			html += '	</div>';
			var is_checked = (category == "28n75n76n90")? " on " : "";
			html += '	<div class="item_menu">';
			html += '		<div class="flex-item '+is_checked+'" data-category="28n75n76n90"><h5 class="menu_name">배변용품</h5></div>';
			html += '	</div>';
			var is_checked = (category == "33n77n78n79n80")? " on " : "";
			html += '	<div class="item_menu">';
			html += '		<div class="flex-item '+is_checked+'" data-category="33n77n78n79n80"><h5 class="menu_name">장난감</h5></div>';
			html += '	</div>';
			var is_checked = (category == "34")? " on " : "";
			html += '	<div class="item_menu">';
			html += '		<div class="flex-item '+is_checked+'" data-category="34"><h5 class="menu_name">노즈워크</h5></div>';
			html += '	</div>';
			var is_checked = (category == "36")? " on " : "";
			html += '	<div class="item_menu">';
			html += '		<div class="flex-item '+is_checked+'" data-category="36"><h5 class="menu_name">산책용품</h5></div>';
			html += '	</div>';
			html += '</div>';
