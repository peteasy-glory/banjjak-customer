					...
					$.each(data.data.list, function(i, v){
						...
						$.each(parse_cart_data, function(i2, v2){
							...
							if(v2.is_free_shipping == 1){
								if(cart_data.ip_seq == "7"){
									is_free_shipping_total[3]++;
									console.log("진행total"+is_free_shipping_total[3]);
								}else{
							...
							if(cart_data.ip_seq == "7"){
								...
								console.log("진행cnt"+is_free_shipping_cnt[3] +"/ " +is_free_shipping_cnt[1]+ "/ " +is_free_shipping_cnt[2]);
							}else{
						...
						if(v.ip_seq == '7'){
							...
							console.log("진행"+is_free_shipping_price[3]);
						}else{
