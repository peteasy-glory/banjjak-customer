...
<div id="fixed-menu">
	<div class="fixed-menu-wrap">
		...
		<div class="center_menu">반짝 신규상품 할인전
		</div>
...
<!-- 		<img src="../images/view_event23.jpg" /> -->
		<img src="../images/view_event26_1.jpg" />
	</div>
...
<script>
	var $event = $("#event");
	var event_item_list1 = ['CN-BM-A01-BOGO', 'CN-TT-A01','CN-W-A01']; // 'CN-T-A01', 'CN-BM-A01',
	var event_item_list2 = ['ETCB-DB-A02','ETCB-DB-A04','ETCB-DB-A06','ETCB-DB-A10','ETCB-DB-A11'];
	var event_item_list3 = ['JB-TREAT-A383','JB-TREAT-A384','JB-TREAT-A385','JB-TREAT-A386','JB-TREAT-A387','JB-TREAT-A388'];
	var event_item_list4 = ['JB-TREAT-A391','JB-TREAT-A392','JB-TREAT-A393','JB-TREAT-A394'];
	var event_item_list5 = ['JB-TREAT-A395','JB-TREAT-A396','JB-TREAT-A397','JB-TREAT-A398','JB-TREAT-A399'];
	var event_item_list6 = ['JB-TREAT-A381','JB-TREAT-A382','JB-TREAT-A389','JB-TREAT-A390'];
	var event_item_list7 = ['JB-TREAT-A375','JB-TREAT-A376','JB-TREAT-A377','JB-TREAT-A378','JB-TREAT-A400','JB-TREAT-A401','JB-TREAT-A402','JB-TREAT-A403','JB-TREAT-A404','JB-TREAT-A405'
,'JB-TREAT-A406','JB-TREAT-A407','JB-TREAT-A408','JB-TREAT-A409','JB-TREAT-A410','JB-TREAT-A411'];

	var sub_title = ['반짝 NEW','메리도그','덴탈껌','껌','뼈간식','저키/트릿','사시미/육포'];
