<?php    
	...
	$client_secret = 'eyJraWQiOiI5MzRKQTVBNlIzIiwiYWxnIjoiRVMyNTYifQ.eyJpc3MiOiI3U01TUEo2RDhQIiwiaWF0IjoxNjU3MTY4MjgzLCJleHAiOjE2NzI3MjAyODMsImF1ZCI6Imh0dHBzOi8vYXBwbGVpZC5hcHBsZS5jb20iLCJzdWIiOiJjb20uZ29wZXQuYmFuamphayJ9.wN6A08R7UaoFGzfYnAjQnXGz50UHbEPRLj_pDOoYwpZHb_0ruB-YCkwAYffCr1tDjlOxY_ZGNhlmgG0PCY2YUw';
	...
	if(isset($_REQUEST['code'])){
		...
		*/
		...
		header("LOCATION: https://customer.banjjakpet.com/login/apple_cellphone?status=success&email={$claims->email}&sub={$claims->sub}");
	}else{
