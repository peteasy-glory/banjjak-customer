...
<div id="main-content" style=" padding-bottom: calc(constant(safe-area-inset-bottom) + 40px); padding-bottom: calc(env(safe-area-inset-bottom) + 40px);">
	...
	<div class="location_tab" style="margin-top:58px;">
		<div style="position:fixed;left:0;top:0px;background:#fff;z-index:10;width:100%;height:60px;">
	...
	<div id="event_7">
		<div id="event" style="margin-top:65px;">
				...
				if(data.code == "000000"){
					...
					if(data.data && data.data.length > 0){
						$.each(data.data, function(i, v){
							html += '<div class="location_middl" style="height:40px;border-bottom:1px solid #ccc;line-height:40px;font-size:14px;color:#f6bf2e;" onclick="location.href=\'search_item_1.php?selected_sort='+selected_sort+'&word='+v.search.replace(/ /gi, '%\' and product_name like \'%')+'\'">'+v.num;
							html += '	<a href="search_item_1.php?selected_sort='+selected_sort+'&word='+v.search.replace(/ /gi, '%\' and product_name like \'%')+'"  style="margin-left:7px;">'+v.search+'</a>';
							html += '</div>';
...
//							html += '</tr>';
							html += '<img src="" id="banner_img" onclick="location.href='+link+'" style="width:100%;padding:20px 20px;box-sizing:border-box;">'
						});
