...
if( strpos($_SERVER['HTTP_USER_AGENT'], "APP_GOBEAUTY_AND") > 0) { 
	echo "<script>location.href=\"/pet/mainpage/index_lisa.php?top={$r_top}&middle={$r_middle}&lat={$r_lat}&lng={$r_lng}&tab={$r_tab}&selected_sort={$r_selected_sort}\";</script>";
}

//if($user_id == "kungem@hotmail.com") {	 
	//print_r($_SERVER);

	// 20210608 by migo - ios 1.2 버젼 강제 이동용
	if( strpos($_SERVER['HTTP_USER_AGENT'], "APP_GOBEAUTY_iOS") > 0) { 
	?>
	<script>
		// ios (include/top.php) window.webkit.messageHandler.getVersion 호출에 대한 결과 확인용 func
		function getVersion(ver) {
			if(ver == "1.2" && (window.location.pathname == "/pet/mainpage/index.php" || window.location.pathname == "/pet/mainpage/") ) {
				<?="location.href='/pet/mainpage/index_lisa.php?top={$r_top}&middle={$r_middle}&lat={$r_lat}&lng={$r_lng}&tab={$r_tab}&selected_sort={$r_selected_sort}';";?>
			} else {
				//alert('최신 버젼으로 업데이트 바랍니다.');	// app 자체에서 안내창 표시로, 미사용
			}
		}
	</script>
	<?
			...
			<div class="swiper-container_front">
				<div class="swiper-wrapper">
					...
					<div class="swiper-slide">
						<a href="javascript:;">
							<img src="../images/20210611popup.jpg" />
						</a>
					</div>
		...
		if(tab == "1"){
			...
			$("#item_select").on('change', function(){
				...
				if (selected_sort == "강아지"){
					select_dog_val = 'selected';
					select_cat_val = '';
					location.href="https://gopet.kr/pet/mainpage/index.php?tab=3&selected_sort=강아지";
...
//						.then(no_app);
					...
					select_cat_val = 'selected';
					select_dog_val = '';
					location.href="https://gopet.kr/pet/mainpage/index.php?tab=3&selected_sort=고양이";
//					$("#fixed-menu #search_link").attr("href","<?=$mainpage_directory ?>/search_item.php?tab="+tab+"&selected_sort="+selected_sort);
//					get_customer()
//						.then(item_html_cat)
...
//				get_customer()
					...
					if(data.code == "000000"){
						...
						if(data.data.list && data.data.list.length > 0){
							...
							$.each(data.data.list, function(i, v){
								var target = (v.target && v.target != "")? v.target : "";
								var link = (v.link && v.link != "")? v.link : "";
								var backurl = 'backurl='+encodeURIComponent(window.location.pathname+'?tab='+tab+'&selected_sort=고양이&top='+r_top+'&middle='+r_middle+'&lat='+r_lat+'&lng='+r_lng);
								link = (link != "")? ((link.indexOf('?') != -1)? link+'&'+backurl : link+'?'+backurl) : "";
								link = (link != "")? '<a href="'+link+'" target="'+target+'"><div class="item_image"></div></a>' : '<a href="javascript:;"><div class="item_image"></div></a>';
								if(v.is_use == "1"){
									if(v.is_use_time == "1"){
						...
						html += '	<div class="item_menu">';
						html += '		<div class="flex-item"><div class="inner"><a href="../item/?category=53&backurl='+encodeURIComponent(window.location.pathname+'?tab='+tab+'&selected_sort=고양이&top='+r_top+'&middle='+r_middle+'&lat='+r_lat+'&lng='+r_lng)+'"><img src="../images/item_menu_icon_51_52_53.png"><h5 class="menu_name">키튼(1세미만)</h5></a></div></div>';
						html += '	</div>';
						html += '	<div class="item_menu">';
						html += '		<div class="flex-item"><div class="inner"><a href="../item/?category=54&backurl='+encodeURIComponent(window.location.pathname+'?tab='+tab+'&selected_sort=고양이&top='+r_top+'&middle='+r_middle+'&lat='+r_lat+'&lng='+r_lng)+'"><img src="../images/item_menu_icon_51_52_54.png"><h5 class="menu_name">어덜트(1-6세)</h5></a></div></div>';
						html += '	</div>';
						html += '	<div class="item_menu">';
						html += '		<div class="flex-item"><div class="inner"><a href="../item/?category=55&backurl='+encodeURIComponent(window.location.pathname+'?tab='+tab+'&selected_sort=고양이&top='+r_top+'&middle='+r_middle+'&lat='+r_lat+'&lng='+r_lng)+'"><img src="../images/item_menu_icon_51_52_55.png"><h5 class="menu_name">시니어(7세이상)</h5></a></div></div>';
						html += '	</div>';
						html += '	<div class="item_menu">';
						html += '		<div class="flex-item"><div class="inner"><a href="../item/?category=56&backurl='+encodeURIComponent(window.location.pathname+'?tab='+tab+'&selected_sort=고양이&top='+r_top+'&middle='+r_middle+'&lat='+r_lat+'&lng='+r_lng)+'"><img src="../images/item_menu_icon_51_52_56.png"><h5 class="menu_name">전연령</h5></a></div></div>';
						html += '	</div>';
						html += '	<div class="item_menu">';
						html += '		<div class="flex-item"><div class="inner"><a href="../item/?category=58&backurl='+encodeURIComponent(window.location.pathname+'?tab='+tab+'&selected_sort=고양이&top='+r_top+'&middle='+r_middle+'&lat='+r_lat+'&lng='+r_lng)+'"><img src="../images/item_menu_icon_51_52_58.png"><h5 class="menu_name">건식사료</h5></a></div></div>';
						html += '	</div>';
						html += '	<div class="item_menu">';
						html += '		<div class="flex-item"><div class="inner"><a href="../item/?category=59&backurl='+encodeURIComponent(window.location.pathname+'?tab='+tab+'&selected_sort=고양이&top='+r_top+'&middle='+r_middle+'&lat='+r_lat+'&lng='+r_lng)+'"><img src="../images/item_menu_icon_51_52_59.png"><h5 class="menu_name">주식캔</h5></a></div></div>';
						html += '	</div>';
						html += '	<div class="item_menu">';
						html += '		<div class="flex-item"><div class="inner"><a href="../item/?category=60&backurl='+encodeURIComponent(window.location.pathname+'?tab='+tab+'&selected_sort=고양이&top='+r_top+'&middle='+r_middle+'&lat='+r_lat+'&lng='+r_lng)+'"><img src="../images/item_menu_icon_51_52_60.png"><h5 class="menu_name">파우치</h5></a></div></div>';
						html += '	</div>';
						html += '	<div class="item_menu">';
						html += '		<div class="flex-item"><div class="inner"><a href="../item/item_category_list.php?cate=51&category=52&backurl='+encodeURIComponent(window.location.pathname+'?tab='+tab+'&selected_sort=고양이&top='+r_top+'&middle='+r_middle+'&lat='+r_lat+'&lng='+r_lng)+'"><img src="../images/item_menu_icon_more2.png"><h5 class="menu_name">+ 더보기</h5></a></div></div>';
						html += '	</div>';
						html += '</div>';

						html += '<div class="item_menu_list" data-id="61">';
						html += '	<div class="item_menu">';
						html += '		<div class="flex-item"><div class="inner"><a href="../item/?category=62&backurl='+encodeURIComponent(window.location.pathname+'?tab='+tab+'&selected_sort=고양이&top='+r_top+'&middle='+r_middle+'&lat='+r_lat+'&lng='+r_lng)+'"><img src="../images/item_menu_icon_51_61_62.png"><h5 class="menu_name">간식캔</h5></a></div></div>';
						html += '	</div>';
						html += '	<div class="item_menu">';
						html += '		<div class="flex-item"><div class="inner"><a href="../item/?category=63&backurl='+encodeURIComponent(window.location.pathname+'?tab='+tab+'&selected_sort=고양이&top='+r_top+'&middle='+r_middle+'&lat='+r_lat+'&lng='+r_lng)+'"><img src="../images/item_menu_icon_51_61_63.png"><h5 class="menu_name">간식파우치</h5></a></div></div>';
						html += '	</div>';
						html += '	<div class="item_menu">';
						html += '		<div class="flex-item"><div class="inner"><a href="../item/?category=67&backurl='+encodeURIComponent(window.location.pathname+'?tab='+tab+'&selected_sort=고양이&top='+r_top+'&middle='+r_middle+'&lat='+r_lat+'&lng='+r_lng)+'"><img src="../images/item_menu_icon_51_61_67.png"><h5 class="menu_name">져키/스틱</h5></a></div></div>';
						html += '	</div>';
						html += '	<div class="item_menu">';
						html += '		<div class="flex-item"><div class="inner"><a href="../item/?category=66&backurl='+encodeURIComponent(window.location.pathname+'?tab='+tab+'&selected_sort=고양이&top='+r_top+'&middle='+r_middle+'&lat='+r_lat+'&lng='+r_lng)+'"><img src="../images/item_menu_icon_51_61_66.png"><h5 class="menu_name">캣닢/캣그라스</h5></a></div></div>';
						html += '	</div>';
						html += '	<div class="item_menu">';
						html += '		<div class="flex-item"><div class="inner"><a href="../item/?category=68&backurl='+encodeURIComponent(window.location.pathname+'?tab='+tab+'&selected_sort=고양이&top='+r_top+'&middle='+r_middle+'&lat='+r_lat+'&lng='+r_lng)+'"><img src="../images/item_menu_icon_51_61_68.png"><h5 class="menu_name">스낵</h5></a></div></div>';
						html += '	</div>';
						html += '	<div class="item_menu">';
						html += '		<div class="flex-item"><div class="inner"><a href="../item/?category=64&backurl='+encodeURIComponent(window.location.pathname+'?tab='+tab+'&selected_sort=고양이&top='+r_top+'&middle='+r_middle+'&lat='+r_lat+'&lng='+r_lng)+'"><img src="../images/item_menu_icon_51_61_64.png"><h5 class="menu_name">동결/건조</h5></a></div></div>';
						html += '	</div>';
						html += '	<div class="item_menu">';
						html += '		<div class="flex-item"><div class="inner"><a href="../item/?category=73&backurl='+encodeURIComponent(window.location.pathname+'?tab='+tab+'&selected_sort=고양이&top='+r_top+'&middle='+r_middle+'&lat='+r_lat+'&lng='+r_lng)+'"><img src="../images/item_menu_icon_51_61_73.png"><h5 class="menu_name">영양제</h5></a></div></div>';
						html += '	</div>';
						html += '	<div class="item_menu">';
						html += '		<div class="flex-item"><div class="inner"><a href="../item/item_category_list.php?cate=51&category=61&backurl='+encodeURIComponent(window.location.pathname+'?tab='+tab+'&selected_sort=고양이&top='+r_top+'&middle='+r_middle+'&lat='+r_lat+'&lng='+r_lng)+'"><img src="../images/item_menu_icon_more2.png"><h5 class="menu_name">+ 더보기</h5></a></div></div>';
						html += '	</div>';
						html += '</div>';

						html += '<div class="item_menu_list" data-id="74">';
						html += '	<div class="item_menu">';
						html += '		<div class="flex-item"><div class="inner"><a href="../item/?category=75&backurl='+encodeURIComponent(window.location.pathname+'?tab='+tab+'&selected_sort=고양이&top='+r_top+'&middle='+r_middle+'&lat='+r_lat+'&lng='+r_lng)+'"><img src="../images/item_menu_icon_51_74_75.png"><h5 class="menu_name">응고형모래</h5></a></div></div>';
						html += '	</div>';
						html += '	<div class="item_menu">';
						html += '		<div class="flex-item"><div class="inner"><a href="../item/?category=76&backurl='+encodeURIComponent(window.location.pathname+'?tab='+tab+'&selected_sort=고양이&top='+r_top+'&middle='+r_middle+'&lat='+r_lat+'&lng='+r_lng)+'"><img src="../images/item_menu_icon_51_74_76.png"><h5 class="menu_name">흡수형모래</h5></a></div></div>';
						html += '	</div>';
						html += '	<div class="item_menu">';
						html += '		<div class="flex-item"><div class="inner"><a href="../item/?category=77&backurl='+encodeURIComponent(window.location.pathname+'?tab='+tab+'&selected_sort=고양이&top='+r_top+'&middle='+r_middle+'&lat='+r_lat+'&lng='+r_lng)+'"><img src="../images/item_menu_icon_51_74_77.png"><h5 class="menu_name">낚시대/레이져</h5></a></div></div>';
						html += '	</div>';
						html += '	<div class="item_menu">';
						html += '		<div class="flex-item"><div class="inner"><a href="../item/?category=80&backurl='+encodeURIComponent(window.location.pathname+'?tab='+tab+'&selected_sort=고양이&top='+r_top+'&middle='+r_middle+'&lat='+r_lat+'&lng='+r_lng)+'"><img src="../images/item_menu_icon_51_74_80.png"><h5 class="menu_name">스크래쳐/박스</h5></a></div></div>';
						html += '	</div>';
						html += '	<div class="item_menu">';
						html += '		<div class="flex-item"><div class="inner"><a href="../item/?category=92&backurl='+encodeURIComponent(window.location.pathname+'?tab='+tab+'&selected_sort=고양이&top='+r_top+'&middle='+r_middle+'&lat='+r_lat+'&lng='+r_lng)+'"><img src="../images/item_menu_icon_51_74_92.png"><h5 class="menu_name">캣타워/캣휠</h5></a></div></div>';
						html += '	</div>';
						html += '	<div class="item_menu">';
						html += '		<div class="flex-item"><div class="inner"><a href="../item/?category=84&backurl='+encodeURIComponent(window.location.pathname+'?tab='+tab+'&selected_sort=고양이&top='+r_top+'&middle='+r_middle+'&lat='+r_lat+'&lng='+r_lng)+'"><img src="../images/item_menu_icon_51_74_84.png"><h5 class="menu_name">위생용품</h5></a></div></div>';
						html += '	</div>';
						html += '	<div class="item_menu">';
						html += '		<div class="flex-item"><div class="inner"><a href="../item/?category=82&backurl='+encodeURIComponent(window.location.pathname+'?tab='+tab+'&selected_sort=고양이&top='+r_top+'&middle='+r_middle+'&lat='+r_lat+'&lng='+r_lng)+'"><img src="../images/item_menu_icon_51_74_82.png"><h5 class="menu_name">미용관리</h5></a></div></div>';
						html += '	</div>';
						html += '	<div class="item_menu">';
						html += '		<div class="flex-item"><div class="inner"><a href="../item/item_category_list.php?cate=51&category=74&backurl='+encodeURIComponent(window.location.pathname+'?tab='+tab+'&selected_sort=고양이&top='+r_top+'&middle='+r_middle+'&lat='+r_lat+'&lng='+r_lng)+'"><img src="../images/item_menu_icon_more2.png"><h5 class="menu_name">+ 더보기</h5></a></div></div>';
						html += '	</div>';
						html += '</div>';
						$mainContent.append(html);
					...
					if(data.code == "000000"){
						...
						if(data.data.list && data.data.list.length > 0){
							...
							$.each(data.data.list, function(i, v){
								var percent = (parseInt(v.product_price) == 0 || parseInt(v.sale_price) == 0)? 0 : 100 - (parseInt(v.sale_price) / parseInt(v.product_price) * 100);
								html += '			<li data-id="'+v.il_seq+'">';
								html += '				<a href="<?=$mainpage_directory ?>/item_product_page.php?no='+v.product_no+'&backurl='+encodeURIComponent(window.location.pathname+'?tab='+tab+'&selected_sort=고양이&top='+r_top+'&middle='+r_middle+'&lat='+r_lat+'&lng='+r_lng)+'">';
								if(v.is_soldout == "2"){
									html += '					<div class="item_image soldout"></div>';
									html += '					<ul class="item">';
									html += '						<li class="item_name">'+v.product_name+'</li>';
	...
	function footer_html(){
		return new Promise(function(resolve, reject) {
			...
			html += '	<br/>';
			html += '	<div class="bottom_notice">';
			html += '		<a href="<?=$mainpage_directory ?>/terms_of_service.php">이용약관</a> | <a href="<?=$mainpage_directory ?>/privacy_policy.php">개인정보처리방침</a> | <a onClick="window.open(\'https://www.ftc.go.kr/bizCommPop.do?wrkr_no=1578601070\');" style="cursor:hand;">사업자정보확인</a>';	// href="<?=$mainpage_directory ?>/proprietorship.php"
			html += '	</div>';
	...
	function get_banner(){
		return new Promise(function(resolve, reject) {
			...
			if(tab == "1"){
				...
				html = '';
				html += '<div class="middle_banner">';
				html += '<a href="<?=$mainpage_directory ?>/view_event9.php"><img src="../images/beginingdogbanner.jpg"></a>';/*스와이프 이미지 <img src="../images/middle_banner_6.jpg"> */
				html += '</div>';
				$mainContent.find(".new_beauty_shop").after(html);
			}else if(tab == "3"){
				html = '';
				html += '<div class="middle_banner">';
				html += '<a href="<?=$mainpage_directory ?>/view_event9.php"><img src="../images/middle_banner_9.jpg"></a>';/*스와이프 이미지 <img src="../images/middle_banner_1_1.jpg">*/
				html += '</div>';
				$mainContent.find(".md_choice_item").after(html);

				html = '';
				html += '<div class="middle_banner">';
				html += '<a href="<?=$mainpage_directory ?>/view_event4.php"><img src="../images/beginingdogbanner.jpg"></a>';/*스와이프 이미지 <img src="../images/middle_banner_6.jpg">*/
				html += '</div>';
