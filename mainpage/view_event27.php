...
<div id="fixed-menu">
	<div class="fixed-menu-wrap">
		...
		<div class="center_menu">스크레쳐 할인전
		</div>
...
<!-- 		<img src="../images/view_event23.jpg" /> -->
		<img src="../images/view_event27.jpg" />
	</div>
...
<script>
	var $event = $("#event");
	var event_item_list1 = ['JB-SB-C07','JB-SB-C06','JB-SB-C01','JB-SB-C16','JB-SB-C03','JB-SB-C02','JB-SB-C15','JB-SB-C14','JB-SB-C19','JB-SB-C09','JB-SB-C08',
							'JB-SB-C11','JB-SB-C10','JB-SB-C13','JB-SB-C12','JB-SB-C17','JB-SB-C18']; 
	var event_item_list2 = ['JB-SB-C57','JB-SB-C56','JB-SB-C55','JB-SB-C54','JB-SB-C58','JB-SB-C61','JB-SB-C60','JB-SB-C59','JB-SB-C62'];
	var event_item_list3 = ['JB-SB-C23','JB-SB-C22','JB-SB-C21','JB-SB-C20'];
	var event_item_list4 = ['JB-SB-C36','JB-SB-C35'];
	var event_item_list5 = ['JB-SB-C31','JB-SB-C30','JB-SB-C29','JB-SB-C28','JB-SB-C32','JB-SB-C33','JB-SB-C34'];

	var sub_title = ['프리미요','아이캣','캐토피아','리첼','온캣'];
