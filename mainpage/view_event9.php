...
<div id="fixed-menu">
	<div class="fixed-menu-wrap">
		...
		<div class="center_menu">목욕용품 할인전
		</div>
...
<div id="event_9">
	<div class="banner">
		<img src="../images/view_event9_1.jpg" />
	</div>
...
<script>
	var $event = $("#event");
	var event_item_list1 = ['JB-BA-A19','JB-BA-A20'];
	var event_item_list2 = ['JB-BA-A02','JB-BA-A01','JB-BA-A21'];
	var event_item_list3 = ['JB-BA-A28','JB-BA-A27','JB-BA-A26','JB-BA-A25','ETCB-DB-A04','JB-BA-A46','JB-BA-A45','JB-BA-A48','JB-BA-A47','JB-BA-A44','JB-BA-A41','JB-BA-A42','JB-BA-A38','JB-BA-A40','JB-BA-A32','JB-BA-A34'];
	var event_item_list4 = ['JB-BA-A09','JB-BA-A08','JB-BA-A13','JB-BA-A12','JB-BA-A11','JB-BA-A10'];
	var event_item_list5 = ['JB-S-A71','JB-S-A70','ETCB-DB-A11','ETCB-DB-A10'];
	var sub_title = ['목욕시트','워터리스 샴푸','샴푸','입욕제','탈취제/보습케어'];
	...
	$event.on("click", ".item_link_btn", function(){
		console.log(localStorage.getItem('windowscrolltop_event9'));
		localStorage.setItem('windowscrolltop_event9',$(window).scrollTop()); // scroll position
	...
	function footer_html(){
		return new Promise(function(resolve, reject) {
			...
			*/
			...
			console.log(localStorage.getItem('windowscrolltop_event9'));
			if(localStorage.getItem('windowscrolltop_event9') > 0){
				$('html, body').animate({
					scrollTop: localStorage.getItem('windowscrolltop_event9')
				}, 500, function(){
					localStorage.setItem('windowscrolltop_event9', 0); // scroll position					
				});
			}
		});
	}
