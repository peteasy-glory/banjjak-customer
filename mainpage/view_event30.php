...
<!-- 		<img src="../images/view_event23.jpg" /> -->
		<img src="../images/view_event30.jpg" />
	</div>
...
<script>
	var $event = $("#event");
	var event_item_list1 = ['JB-TREAT-C01','JB-TREAT-C02','JB-TREAT-C03','JB-TREAT-C04','JB-TREAT-C05','JB-TREAT-C06','JB-TREAT-C07','JB-TREAT-C08','JB-TREAT-C31',
							'JB-TREAT-C28','JB-TREAT-C29','JB-TREAT-C23','JB-TREAT-C24','JB-TREAT-C25','JB-TREAT-C26','JB-TREAT-C27','JB-TREAT-C30','JB-TREAT-C32',
							'JB-TREAT-C33','JB-TREAT-C34','JB-TREAT-C35','JB-TREAT-C39','JB-TREAT-C38','JB-TREAT-C36','JB-TREAT-C37','JB-TREAT-C42','JB-TREAT-C40',
							'JB-TREAT-C41','JB-TREAT-C22','JB-TREAT-C21','JB-TREAT-C20','JB-TREAT-C19','JB-TREAT-C17','JB-TREAT-C18','JB-TREAT-C16'];
	var event_item_list2 = ['JB-TREAT-C43','JB-TREAT-C44','JB-TREAT-C45','JB-TREAT-C46'];
	var event_item_list3 = ['JB-TREAT-C47','JB-TREAT-C48','JB-TREAT-C49','JB-TREAT-C50','JB-TREAT-C51','JB-TREAT-C52','JB-TREAT-C53','JB-TREAT-C54'];
	var event_item_list4 = ['JB-TREAT-C55','JB-TREAT-C56','JB-TREAT-C57','JB-TREAT-C58'];
	var event_item_list5 = ['JB-TREAT-C59','JB-TREAT-C60','JB-TREAT-C61','JB-TREAT-C62','JB-TREAT-C63','JB-TREAT-C64','JB-TREAT-C65'];
	var event_item_list6 = ['JB-TREAT-C66','JB-TREAT-C67','JB-TREAT-C68','JB-TREAT-C69','JB-TREAT-C70','JB-TREAT-C71'];

	var sub_title = ['이나바','카네토라','에이프로','페리또얌','미오','캣쮸'];
