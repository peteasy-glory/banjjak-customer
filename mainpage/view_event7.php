...
<div id="fixed-menu">
	<div class="fixed-menu-wrap">
		...
		<div class="center_menu">케어 앤 맘 + 하겐
		</div>
...
<div id="event_7">
	<div class="banner">
		<img src="../images/view_event7_care_banner_2.jpg" />
	</div>
...
<script>
	var $event = $("#event");
	var event_item_list1 = ['JB-BM-A09', 'JB-BM-A12', 'JB-BM-A14', 'JB-BM-A15', 'JB-BM-A17', 'JB-BM-A41', 'JB-BM-A39', 'JB-BM-A40', 'JB-BM-A42', ];
	var event_item_list2 = ['JB-DC-A01', 'JB-BM-A31', 'JB-BM-A27', 'JB-BM-A25', 'JB-BM-A04', 'JB-BM-A06', 'JB-BM-A07', 'JB-BM-A08', 'JB-BM-A47', 'JB-BM-A48'];
	var flag = 0;
	var cnt = 10;
	var lastScrollTop = 0;
	var timer = null;
	...
	$event.on("click", ".item_link_btn", function(){
		console.log(localStorage.getItem('windowscrolltop_event7'));
		localStorage.setItem('windowscrolltop_event7',$(window).scrollTop()); // scroll position
	...
	function get_event_item_list_html(){
		return new Promise(function(resolve, reject) {
			...
			html += '	<div class="title"><span>브러쉬</span></div>';
			...
			html += '	<div class="title"><span>그외 미용용품</span></div>';
			html += '	<div class="caption">';
			html += '		<div class="total_cnt">0개의 상품</div>';
			html += '		<div class="order">';
			//html += '			<select class="orderby">';
	...
	function footer_html(){
		return new Promise(function(resolve, reject) {
			...
			*/
			...
			console.log(localStorage.getItem('windowscrolltop_event7'));
			if(localStorage.getItem('windowscrolltop_event7') > 0){
				$('html, body').animate({
					scrollTop: localStorage.getItem('windowscrolltop_event7')
				}, 500, function(){
					localStorage.setItem('windowscrolltop_event7', 0); // scroll position					
				});
			}
		});
	}
