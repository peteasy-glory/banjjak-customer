...
<div id="fixed-menu">
	<div class="fixed-menu-wrap">
		...
		<div class="center_menu">초보견주 할인전
		</div>
...
<div id="event_7">
	<div class="banner">
<!-- 		<img src="../images/view_event23.jpg" /> -->
		<img src="../upload/main_banner/162097624493.jpg" />
	</div>
...
<script>
	var $event = $("#event");
	var event_item_list1 = ['PE-D-A01','JB-BM-A49','JB-BM-A18','JB-BM-A19','JB-BM-A20','JB-BM-A21','ETCB-DB-A10'];
	var event_item_list2 = ['towel01','JB-BA-A31','JB-BA-A30','JB-BA-A29','JB-BA-A21','JB-BA-A20','ETCB-DB-A02','ETCB-DB-A04','ETCB-DB-A06'];
	var event_item_list3 = ['JB-FS-A20','JB-FS-A26','JB-FS-A19','JB-FS-A25'];
	var event_item_list4 = ['JB-S-A21','JB-S-A22','JB-S-A23','JB-S-A24','JB-S-A25','JB-S-A26','JB-S-A27','JB-S-A28'];
	var event_item_list5 = ['JB-PP-A01','JB-PP-A02','JB-S-A66','JB-S-A67','JB-S-A30','JB-S-A29','JB-S-A31','JB-S-A20','JB-PP-A03','JB-PP-A04'];
	var event_item_list6 = ['JB-FFW-A70','JB-FFW-A73','JB-FFW-A72','JB-FFW-A71','JB-FFW-A21','JB-FFW-A20','JB-FFW-A19','JB-FFW-A18','JB-FFW-A28','JB-FG-A02','JB-FG-A01','JB-FG-A04','JB-FG-A03'];
	var event_item_list7 = ['JB-MC-A17','JB-MC-A16','JB-MC-A15','JB-MC-A10','JB-MC-A09','JB-MC-A08','JB-BC-A02','JB-BC-A01'];
	var event_item_list8 = ['JB-HC-A11','JB-HC-A12','JB-HC-A13','JB-HC-A14','JB-HC-A54','JB-HC-A53','JB-HC-A26','JB-HC-A27','JB-SM-A15','JB-SM-A14'];
	var event_item_list9 = ['JB-TNW-A13','JB-TNW-A09','JB-TNW-A07','JB-TNW-A08','JB-T-A01','JB-T-A02','JB-T-A80','JB-T-A79','JB-T-A78','JB-T-A85','JB-T-A84','JB-T-A86','JB-T-A91','JB-T-A94'];
	var event_item_list10 = ['JB-MEAL-A25','JB-MEAL-A18','JB-MEAL-A19','JB-MEAL-A24','JB-MEAL-A23','JB-MEAL-A22','JB-MEAL-A31','JB-MEAL-A32','JB-MEAL-A33','JB-MEAL-A34','JB-MEAL-A35'];
	var event_item_list11 = ['JB-TREAT-A162','JB-TREAT-A163','JB-TREAT-A164','JB-TREAT-A165','JB-TREAT-A247','JB-TREAT-A248','JB-TREAT-A250','JB-TREAT-A249','JB-TREAT-A272','JB-TREAT-A273','JB-TREAT-A274','JB-TREAT-A275','JB-TREAT-A276',
							'JB-TREAT-A277','JB-TREAT-A278','JB-TREAT-A279','JB-TREAT-A280','JB-TREAT-A328','JB-TREAT-A322','JB-TREAT-A325','JB-TREAT-A294','JB-TREAT-A293','JB-TREAT-A98','JB-TREAT-A99','JB-TREAT-A100'];

	var sub_title = ['미용/관리','목욕용품','울타리/안전문','기저귀','배변용품','리빙용품','이동장/가방','하우스/방석/매트','장난감/노즈워크','사료','간식'];
	...
	$(function(){
		...
		get_event_item_list_html()
			...
			.then(get_event_list10)
			.then(get_event_list11)
	...
	function get_event_list10(){
		return new Promise(function(resolve, reject) {
			var p = $.when();
			var c = 0;
			$.each(event_item_list10, function(i, v){
				p = p.then(function(){
					c++;
					if(c == event_item_list10.length){
						$event.find('.item_list10 .total_cnt').text(event_item_list10.length+'개의 상품');
						resolve();
					}
					return get_item_list(v, 10);
				});
			});
		});
	}
	function get_event_list11(){
		return new Promise(function(resolve, reject) {
			var p = $.when();
			var c = 0;
			$.each(event_item_list11, function(i, v){
				p = p.then(function(){
					c++;
					if(c == event_item_list11.length){
						$event.find('.item_list11 .total_cnt').text(event_item_list11.length+'개의 상품');
						resolve();
					}
					return get_item_list(v, 11);
				});
			});
		});
	}
