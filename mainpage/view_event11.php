...
<div id="event_10">
	<div class="banner">
		<img src="../images/view_event11.jpg" />
	</div>
...
<script>
	var $event = $("#event");
	var event_item_list1 = ['ETCB-DB-A01','ETCB-DB-A02','ETCB-DB-A03','ETCB-DB-A12','ETCB-DB-A04','ETCB-DB-A05','ETCB-DB-A13','ETCB-DB-A10','ETCB-DB-A08','ETCB-DB-A09','ETCB-DB-A14','ETCB-DB-A07','ETCB-DB-A06','ETCB-DB-A11'];
	var event_item_list2 = ['JB-TREAT-A272','JB-TREAT-A273','JB-TREAT-A274','JB-TREAT-A275','JB-TREAT-A276','JB-TREAT-A277','JB-TREAT-A278','JB-TREAT-A279','JB-TREAT-A280'];
	var event_item_list3 = ['JB-TREAT-A55','JB-TREAT-A56','JB-TREAT-A57','JB-TREAT-A52','JB-TREAT-A53','JB-TREAT-A54','JB-HM-A51','JB-HM-A52'];
	var event_item_list4 = ['JB-TREAT-A01','JB-TREAT-A02','JB-TREAT-A03','JB-TREAT-A04','JB-TREAT-A05','JB-TREAT-A06'];
	var event_item_list5 = ['JB-TT-A10','JB-T-A70','JB-T-A71','JB-T-A72','JB-T-A109'];
	var event_item_list6 = ['JB-T-A82','JB-T-A83','JB-T-A99'];
	var event_item_list7 = ['JB-FG-A03','JB-FG-A04'];
	var event_item_list8 = ['JB-W-A34','JB-W-A35'];
	var event_item_list9 = ['JB-BM-A01','JB-BM-A02','JB-BM-A03','towel01'];
	var sub_title = ['메리도그','더내추럴','포켄스','허니버터링','칼리','펫블랑','이지메이트','쏘아베','쉐드 시리즈 & 반짝'];
	var flag = 0;
	var cnt = 10;
	var lastScrollTop = 0;
	var timer = null;
	...
	$event.on("click", ".item_link_btn", function(){
		console.log(localStorage.getItem('windowscrolltop_event11'));
		localStorage.setItem('windowscrolltop_event11',$(window).scrollTop()); // scroll position
	...
	function footer_html(){
		return new Promise(function(resolve, reject) {
			...
			*/
			...
			console.log(localStorage.getItem('windowscrolltop_event11'));
			if(localStorage.getItem('windowscrolltop_event11') > 0){
				$('html, body').animate({
					scrollTop: localStorage.getItem('windowscrolltop_event11')
				}, 500, function(){
					localStorage.setItem('windowscrolltop_event11', 0); // scroll position					
				});
			}
		});
	}
