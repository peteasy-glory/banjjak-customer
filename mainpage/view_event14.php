...
<div id="fixed-menu">
	<div class="fixed-menu-wrap">
		...
		<div class="center_menu">'요요쉬' 시리즈 특가
		</div>
...
<div id="event_7">
	<div class="banner">
		<img src="../upload/main_banner/161917053358.jpg" />
	</div>
...
<script>
	var $event = $("#event");
	var event_item_list1 = ['JB-PP-A08','JB-PP-A09','JB-S-A42','JB-S-A43','JB-S-A44','JB-S-A45'];
	var event_item_list2 = ['JB-S-A37','JB-S-A38','JB-S-A39','JB-S-A40','JB-S-A41','JB-S-A34','JB-S-A35','JB-S-A36'];
	var sub_title = ['배변패드','기저귀'];
	...
	$event.on("click", ".item_link_btn", function(){
		console.log(localStorage.getItem('windowscrolltop_event14'));
		localStorage.setItem('windowscrolltop_event14',$(window).scrollTop()); // scroll position
	...
	function footer_html(){
		return new Promise(function(resolve, reject) {
			...
			*/
			...
			console.log(localStorage.getItem('windowscrolltop_event14'));
			if(localStorage.getItem('windowscrolltop_event14') > 0){
				$('html, body').animate({
					scrollTop: localStorage.getItem('windowscrolltop_event14')
				}, 500, function(){
					localStorage.setItem('windowscrolltop_event14', 0); // scroll position					
				});
			}
		});
	}
