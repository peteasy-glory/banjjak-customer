...
?>
    ...
    <div style="position:fixed;bottom:15px;right:calc(50% - 30px);z-index:99999;">
            <a href="<?=$shop_directory?>/manage_sell_info_new.php?ch=month" class="phone_button"><img src="<?=$image_directory?>/phone-1459352_640.png" style="width:60px;height:60px;"></a>
    </div>
