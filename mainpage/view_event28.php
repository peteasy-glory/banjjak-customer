...
<!-- 		<img src="../images/view_event23.jpg" /> -->
		<img src="../images/view_event28.jpg" />
	</div>
...
<script>
	var $event = $("#event");
	var event_item_list1 = ['JB-T-A25','JB-BD-C53','JB-FRLP-C80','JB-FRLP-C81','JB-FRLP-C16','JB-FRLP-C17','JB-BD-C27','JB-BD-C28','JB-FRLP-C20','JB-FRLP-C15',
							'JB-BD-C26','JB-BD-C31','JB-BD-C30','JB-BD-C29','JB-BD-C40','JB-BD-C41','JB-BD-C60','JB-BD-C59','JB-BD-C61','JB-BD-C45','JB-BD-C46',
							'JB-BD-C47','JB-CNCG-C47','JB-CNCG-C43','JB-CNCG-C44']; 
	var event_item_list2 = ['JB-CNCG-C34','JB-CNCG-C36','JB-CNCG-C37','JB-CNCG-C38','JB-CNCG-C06','JB-CNCG-C07','JB-CNCG-C04','JB-CNCG-C05','JB-CNCG-C14','JB-CNCG-C15'];

	var sub_title = ['장난감','그 외'];
