...
<div id="fixed-menu">
	<div class="fixed-menu-wrap">
		...
		<div class="center_menu">비스킷/쿠키 할인전
		</div>
...
<div id="event_7">
	<div class="banner">
		<img src="../upload/main_banner/161956983830.jpg" />
	</div>
...
<script>
	var $event = $("#event");
	var event_item_list1 = ['JB-TREAT-A01', 'JB-TREAT-A02', 'JB-TREAT-A03', 'JB-TREAT-A04', 'JB-TREAT-A05', 'JB-TREAT-A06'];
	var event_item_list2 = ['JB-TREAT-A22', 'JB-TREAT-A23', 'JB-TREAT-A24', 'JB-TREAT-A25', 'JB-TREAT-A26', 'JB-TREAT-A27', 'JB-TREAT-A28', 'JB-TREAT-A29', 'JB-TREAT-A30', 'JB-TREAT-A31', 'JB-TREAT-A32', 'JB-TREAT-A33'];
	var event_item_list3 = ['JB-TREAT-A47', 'JB-TREAT-A48', 'JB-TREAT-A49', 'JB-TREAT-A50', 'JB-TREAT-A51'];
	var event_item_list4 = ['JB-TREAT-A98', 'JB-TREAT-A99', 'JB-TREAT-A100', 'JB-TREAT-A331', 'JB-TREAT-A330', 'JB-TREAT-A329', 'JB-TREAT-A332'];
	var sub_title = ['허니버터링','쥬뻬','굿프랜드','바우와우'];
	...
	$event.on("click", ".item_link_btn", function(){
		console.log(localStorage.getItem('windowscrolltop_event18'));
		localStorage.setItem('windowscrolltop_event18',$(window).scrollTop()); // scroll position
	...
	function footer_html(){
		return new Promise(function(resolve, reject) {
			...
			*/
			...
			console.log(localStorage.getItem('windowscrolltop_event18'));
			if(localStorage.getItem('windowscrolltop_event18') > 0){
				$('html, body').animate({
					scrollTop: localStorage.getItem('windowscrolltop_event18')
				}, 500, function(){
					localStorage.setItem('windowscrolltop_event18', 0); // scroll position					
				});
			}
		});
	}
