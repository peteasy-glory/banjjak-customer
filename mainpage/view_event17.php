...
<div id="fixed-menu">
	<div class="fixed-menu-wrap">
		...
		<div class="center_menu">오리고기 할인전
		</div>
...
<div id="event_7">
	<div class="banner">
		<img src="../images/view_event17.jpg" />
	</div>
...
<script>
	var $event = $("#event");
	var event_item_list1 = ['JB-TREAT-A225', 'JB-TREAT-A226', 'JB-TREAT-A227', 'JB-TREAT-A156', 'JB-TREAT-A157', 'JB-TREAT-A158'];
	var event_item_list2 = ['JB-TREAT-A121', 'JB-TREAT-A122', 'JB-TREAT-A123', 'JB-TREAT-A124', 'JB-TREAT-A125', 'JB-TREAT-A126', 'JB-TREAT-A130'];
	var event_item_list3 = ['JB-TREAT-A228', 'JB-TREAT-A236', 'JB-TREAT-A104', 'JB-TREAT-A105', 'JB-TREAT-A107', 'JB-TREAT-A140'];
	var event_item_list4 = ['JB-TREAT-A145', 'JB-TREAT-A146', 'JB-TREAT-A147'];
	var event_item_list5 = ['JB-TREAT-A214', 'JB-TREAT-A215', 'JB-TREAT-A216', 'JB-TREAT-A221', 'JB-TREAT-A222', 'JB-TREAT-A223', 'JB-TREAT-A189', 'JB-TREAT-A192', 'JB-TREAT-A96', 'JB-TREAT-A245'];
	var event_item_list6 = ['JB-TREAT-A88', 'JB-TREAT-A89', 'JB-TREAT-A90', 'JB-TREAT-A93'];
	var event_item_list7 = ['JB-TREAT-A08', 'JB-TREAT-A265', 'JB-TREAT-A269', 'JB-TREAT-A200', 'JB-TREAT-A298', 'JB-TREAT-A101'];
	var sub_title = ['견심 & 보니또','더원','참좋은간식','착한간식','펫슐랭','호천펫','그 외'];
	...
	$event.on("click", ".item_link_btn", function(){
		console.log(localStorage.getItem('windowscrolltop_event17'));
		localStorage.setItem('windowscrolltop_event17',$(window).scrollTop()); // scroll position
	...
	function footer_html(){
		return new Promise(function(resolve, reject) {
			...
			*/
			...
			console.log(localStorage.getItem('windowscrolltop_event17'));
			if(localStorage.getItem('windowscrolltop_event17') > 0){
				$('html, body').animate({
					scrollTop: localStorage.getItem('windowscrolltop_event17')
				}, 500, function(){
					localStorage.setItem('windowscrolltop_event17', 0); // scroll position					
				});
			}
		});
	}
