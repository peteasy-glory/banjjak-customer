        ...
        <div class="custom_modal popup_wrap">
            <div class="custom-modal-content">
                ...
                <div class="popup_btn_wrap">
                    ...
                    <button class="popup_btn_02" onclick="close_popup_for_days(1)">괜찮습니다. 그냥 볼게요!</button>
                </div>
            </div>
        </div>
<?php
...
?>
    ...
    ?>
        <center>
            <br>
            <font style="font-size:14px;">이 지역에 등록된<br>
            </font>
            <font style="font-size:14px;">펫샵/펫스타일리스트가 없습니다.<br>
            </font>
        </center>
    <?php
    }
    ...
    <div onclick="javascript:add_section();" style=" width:90%; margin: 0px auto; padding:10px 0px; background-color: #f5bf2e;  text-align:center;font-size:15px;color:#ffffff;border-radius: 5px;">더보기</div>
    <?php
    if ($rai == 0) {
    ?>
        <center>
    ...
    <font style="font-size:11px;color:#333333;line-height:1em;" class="bottom_notice">
        <div class="f_subwrap">
            <ul>
                ...
                <li>서울 노원구 동일로 174길 27 서울창업디딤터 3층 301호</li>
