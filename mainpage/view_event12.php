...
<script src="<?= $js_directory ?>/countdown.js"></script>
...
<div id="event_9">
	<div class="banner">
		<img src="../images/view_event12_1.jpg" />
	</div>
    <div class="countdown" data-date="07-02-2021" data-time="23:59">
		<div>진행중</div>
...
<script>
	var $event = $("#event");
	var event_item_list1 = ['JB-BA-A20','JB-BA-A21','ETCB-DB-A07','ETCB-DB-A01','ETCB-DB-A06','ETCB-DB-A12','ETCB-DB-A13','towel01']; // , 'JB-BA-A03', 'JB-BA-A04', 'JB-BA-A05', 'JB-BA-A06', 'JB-BA-A07' 품절
	var event_item_list2 = ['JB-S-A138', 'JB-S-A03', 'JB-S-A05', 'JB-S-A37','JB-S-A42', 'JB-S-A43', 'JB-S-A44','JB-S-A45','ETCB-DB-A14'];
	var event_item_list3 = ['JB-BM-A18', 'JB-BM-A19','JB-BM-A20','JB-BM-A21','JB-BM-A01','JB-BM-A02','JB-BM-A03','PE-D-A01','ETCB-DB-A10'];
	var event_item_list4 = ['JB-DC-A38', 'JB-DC-A37','JB-DC-A36','JB-DC-A35','JB-DC-A20'];
	var event_item_list5 = ['JB-HM-A49', 'JB-HM-A48','JB-HM-A42','JB-HM-A44','JB-HM-A21','JB-HM-A50'];
	var flag = 0;
	var cnt = 10;
	var lastScrollTop = 0;
	var timer = null;
	...
	$event.on("click", ".item_link_btn", function(){
		console.log(localStorage.getItem('windowscrolltop_event12'));
		localStorage.setItem('windowscrolltop_event12',$(window).scrollTop()); // scroll position
	...
	function get_event_item_list_html(){
		return new Promise(function(resolve, reject) {
			...
			html += '	<div class="title"><span>목욕용품</span></div>';
			...
			html += '	<div class="title"><span>위생용품</span></div>';
			html += '	<div class="caption">';
			html += '		<div class="total_cnt">0개의 상품</div>';
			html += '		<div class="order">';
			//html += '			<select class="orderby">';
			...
			html += '	<div class="title"><span>미용관리</span></div>';
			html += '	<div class="caption">';
			html += '		<div class="total_cnt">0개의 상품</div>';
			html += '		<div class="order">';
			//html += '			<select class="orderby">';
			...
			html += '	<div class="title"><span>칫솔치약</span></div>';
			html += '	<div class="caption">';
			html += '		<div class="total_cnt">0개의 상품</div>';
			html += '		<div class="order">';
			//html += '			<select class="orderby">';
			...
			html += '	<div class="title"><span>건강관리</span></div>';
			html += '	<div class="caption">';
			html += '		<div class="total_cnt">0개의 상품</div>';
			html += '		<div class="order">';
			//html += '			<select class="orderby">';
						...
						if(data.data.list && data.data.list.length > 0){
							$.each(data.data.list, function(i, v){
								...
								if(v.is_soldout == "2"){
									...
									html += '				<div class="item_image timesale"></div>';
									html += '				<div class="item_name">'+v.product_name+'</div>';
	...
	function footer_html(){
		return new Promise(function(resolve, reject) {
			...
			*/
			...
			console.log(localStorage.getItem('windowscrolltop_event12'));
			if(localStorage.getItem('windowscrolltop_event12') > 0){
				$('html, body').animate({
					scrollTop: localStorage.getItem('windowscrolltop_event12')
				}, 500, function(){
					localStorage.setItem('windowscrolltop_event12', 0); // scroll position					
				});
			}
		});
	}
