<?php
header('Location: http://www.banjjakpet.com/');
exit;
...
<html>
    <head>
        <meta charset="utf-8" />
        <title>반짝</title>
        <link rel="stylesheet" href="../css/index_pc.css?<?= filemtime($upload_static_directory . $css_directory . '/index_pc.css') ?>">
    </head>
    <body>
        <header>
            <div class="wrap">
                ...
                <div class="wrap">
                    <div class="contents">
                        ...
                        <section class="download">
                            ...
                            <div class="link">
                                <div class="img-wrap">
                                    <img src="../images/app_logo.png" alt="앱 로고" />
                                </div>
                                <ul class="app_store">
            ...
            <footer class="section">
                <div class="wrap pc">
                    <div class="contents">
                        ...
                        <p>통신판매업 : 제 2021-서울종로-0183호</p><br>
                        <p>대표메일 : <a href="mailto:help@peteasy.kr">help@peteasy.kr</a></p><br>
                    </div>
                    <div class="multi-field image-field">
                        <img width="45%" src="../images/app_logo.png" alt="앱 로고" />
						<ul>
                            <li><a href="https://play.google.com/store/apps/details?id=m.kr.gobeauty&hl=ko " target="_blank"><img src="/pet/images/gopetkr_image05newR.png" width="150px" alt="구글 플레이 링크 이미지" /></a></li>
                            <li><a href="https://itunes.apple.com/kr/app/id1436568194" target="_blank"><img src="/pet/images/gopetkr_image06newR.png" width="150px" alt="애플 앱스토어 링크 이미지" /></a></li>
                        </ul>
