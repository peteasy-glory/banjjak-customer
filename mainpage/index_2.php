...
//			html += '<option value="강아지" selected>강아지</option>'
//			html += '<option value="고양이">고양이</option>'
//			html += '</select>'
			$("#fixed-menu .center_menu").html(html);
			...
			$.ajax({
				...
				success: function(data) {
					if(data.code == "000000"){
						...
						html += '	</div>';
						html += '	<div class="item_menu">';
						html += '		<div class="flex-item"><div class="inner"><a href="../item/item_category_list.php?category=2&backurl='+encodeURIComponent(window.location.pathname+'?tab='+tab+'&top='+r_top+'&middle='+r_middle+'&lat='+r_lat+'&lng='+r_lng)+'"><img src="../images/item_menu_icon_more2.png"><h5 class="menu_name">+ 더보기</h5></a></div></div>';
						html += '	</div>';
						html += '</div>';
						...
						html += '	</div>';
						html += '	<div class="item_menu">';
						html += '		<div class="flex-item"><div class="inner"><a href="../item/item_category_list.php?category=12&backurl='+encodeURIComponent(window.location.pathname+'?tab='+tab+'&top='+r_top+'&middle='+r_middle+'&lat='+r_lat+'&lng='+r_lng)+'"><img src="../images/item_menu_icon_more2.png"><h5 class="menu_name">+ 더보기</h5></a></div></div>';
						html += '	</div>';
						html += '</div>';
						...
						html += '	</div>';
						html += '	<div class="item_menu">';
						html += '		<div class="flex-item"><div class="inner"><a href="../item/item_category_list.php?category=27&backurl='+encodeURIComponent(window.location.pathname+'?tab='+tab+'&top='+r_top+'&middle='+r_middle+'&lat='+r_lat+'&lng='+r_lng)+'"><img src="../images/item_menu_icon_more2.png"><h5 class="menu_name">+ 더보기</h5></a></div></div>';
						html += '	</div>';
						html += '</div>';
			...
			$.ajax({
				...
				success: function(data) {
					if(data.code == "000000"){
						...
						html += '	<div class="item_menu">';
						html += '		<div class="flex-item"><div class="inner"><a href="../item/?category=53&backurl='+encodeURIComponent(window.location.pathname+'?tab='+tab+'&top='+r_top+'&middle='+r_middle+'&lat='+r_lat+'&lng='+r_lng)+'"><img src="../images/item_menu_icon_1_2_3.png"><h5 class="menu_name">키튼(1세미만)</h5></a></div></div>';
						html += '	</div>';
						html += '	<div class="item_menu">';
						html += '		<div class="flex-item"><div class="inner"><a href="../item/?category=54&backurl='+encodeURIComponent(window.location.pathname+'?tab='+tab+'&top='+r_top+'&middle='+r_middle+'&lat='+r_lat+'&lng='+r_lng)+'"><img src="../images/item_menu_icon_1_2_4.png"><h5 class="menu_name">어덜트(1-6세)</h5></a></div></div>';
						html += '	</div>';
						html += '	<div class="item_menu">';
						html += '		<div class="flex-item"><div class="inner"><a href="../item/?category=55&backurl='+encodeURIComponent(window.location.pathname+'?tab='+tab+'&top='+r_top+'&middle='+r_middle+'&lat='+r_lat+'&lng='+r_lng)+'"><img src="../images/item_menu_icon_1_2_5.png"><h5 class="menu_name">시니어(7세이상)</h5></a></div></div>';
						html += '	</div>';
						html += '	<div class="item_menu">';
						html += '		<div class="flex-item"><div class="inner"><a href="../item/?category=56&backurl='+encodeURIComponent(window.location.pathname+'?tab='+tab+'&top='+r_top+'&middle='+r_middle+'&lat='+r_lat+'&lng='+r_lng)+'"><img src="../images/item_menu_icon_1_2_6.png"><h5 class="menu_name">전연령</h5></a></div></div>';
						html += '	</div>';
						html += '	<div class="item_menu">';
						html += '		<div class="flex-item"><div class="inner"><a href="../item/?category=58&backurl='+encodeURIComponent(window.location.pathname+'?tab='+tab+'&top='+r_top+'&middle='+r_middle+'&lat='+r_lat+'&lng='+r_lng)+'"><img src="../images/item_menu_icon_1_2_10.png"><h5 class="menu_name">건식사료</h5></a></div></div>';
						html += '	</div>';
						html += '	<div class="item_menu">';
						html += '		<div class="flex-item"><div class="inner"><a href="../item/?category=59&backurl='+encodeURIComponent(window.location.pathname+'?tab='+tab+'&top='+r_top+'&middle='+r_middle+'&lat='+r_lat+'&lng='+r_lng)+'"><img src="../images/item_menu_icon_1_2_11.png"><h5 class="menu_name">주식캔</h5></a></div></div>';
						html += '	</div>';
						html += '	<div class="item_menu">';
						html += '		<div class="flex-item"><div class="inner"><a href="../item/?category=60&backurl='+encodeURIComponent(window.location.pathname+'?tab='+tab+'&top='+r_top+'&middle='+r_middle+'&lat='+r_lat+'&lng='+r_lng)+'"><img src="../images/item_menu_icon_1_2_11.png"><h5 class="menu_name">파우치</h5></a></div></div>';
						html += '	</div>';
						html += '	<div class="item_menu">';
						html += '		<div class="flex-item"><div class="inner"><a href="../item/item_category_list.php?category=52&backurl='+encodeURIComponent(window.location.pathname+'?tab='+tab+'&top='+r_top+'&middle='+r_middle+'&lat='+r_lat+'&lng='+r_lng)+'"><img src="../images/item_menu_icon_more2.png"><h5 class="menu_name">+ 더보기</h5></a></div></div>';
						html += '	</div>';
						html += '</div>';

						html += '<div class="item_menu_list" data-id="61">';
						html += '	<div class="item_menu">';
						html += '		<div class="flex-item"><div class="inner"><a href="../item/?category=62&backurl='+encodeURIComponent(window.location.pathname+'?tab='+tab+'&top='+r_top+'&middle='+r_middle+'&lat='+r_lat+'&lng='+r_lng)+'"><img src="../images/item_menu_icon_1_12_13.png"><h5 class="menu_name">간식캔</h5></a></div></div>';
						html += '	</div>';
						html += '	<div class="item_menu">';
						html += '		<div class="flex-item"><div class="inner"><a href="../item/?category=63&backurl='+encodeURIComponent(window.location.pathname+'?tab='+tab+'&top='+r_top+'&middle='+r_middle+'&lat='+r_lat+'&lng='+r_lng)+'"><img src="../images/item_menu_icon_1_12_15.png"><h5 class="menu_name">간식파우치</h5></a></div></div>';
						html += '	</div>';
						html += '	<div class="item_menu">';
						html += '		<div class="flex-item"><div class="inner"><a href="../item/?category=67&backurl='+encodeURIComponent(window.location.pathname+'?tab='+tab+'&top='+r_top+'&middle='+r_middle+'&lat='+r_lat+'&lng='+r_lng)+'"><img src="../images/item_menu_icon_1_12_19.png"><h5 class="menu_name">져키/스틱</h5></a></div></div>';
						html += '	</div>';
						html += '	<div class="item_menu">';
						html += '		<div class="flex-item"><div class="inner"><a href="../item/?category=66&backurl='+encodeURIComponent(window.location.pathname+'?tab='+tab+'&top='+r_top+'&middle='+r_middle+'&lat='+r_lat+'&lng='+r_lng)+'"><img src="../images/item_menu_icon_1_12_20.png"><h5 class="menu_name">캣닢/캣그라스</h5></a></div></div>';
						html += '	</div>';
						html += '	<div class="item_menu">';
						html += '		<div class="flex-item"><div class="inner"><a href="../item/?category=68&backurl='+encodeURIComponent(window.location.pathname+'?tab='+tab+'&top='+r_top+'&middle='+r_middle+'&lat='+r_lat+'&lng='+r_lng)+'"><img src="../images/item_menu_icon_1_12_21.png"><h5 class="menu_name">스낵</h5></a></div></div>';
						html += '	</div>';
						html += '	<div class="item_menu">';
						html += '		<div class="flex-item"><div class="inner"><a href="../item/?category=64&backurl='+encodeURIComponent(window.location.pathname+'?tab='+tab+'&top='+r_top+'&middle='+r_middle+'&lat='+r_lat+'&lng='+r_lng)+'"><img src="../images/item_menu_icon_1_12_23.png"><h5 class="menu_name">동결/건조</h5></a></div></div>';
						html += '	</div>';
						html += '	<div class="item_menu">';
						html += '		<div class="flex-item"><div class="inner"><a href="../item/?category=73&backurl='+encodeURIComponent(window.location.pathname+'?tab='+tab+'&top='+r_top+'&middle='+r_middle+'&lat='+r_lat+'&lng='+r_lng)+'"><img src="../images/item_menu_icon_1_12_26.png"><h5 class="menu_name">영양제</h5></a></div></div>';
						html += '	</div>';
						html += '	<div class="item_menu">';
						html += '		<div class="flex-item"><div class="inner"><a href="../item/item_category_list.php?category=61&backurl='+encodeURIComponent(window.location.pathname+'?tab='+tab+'&top='+r_top+'&middle='+r_middle+'&lat='+r_lat+'&lng='+r_lng)+'"><img src="../images/item_menu_icon_more2.png"><h5 class="menu_name">+ 더보기</h5></a></div></div>';
						html += '	</div>';
						html += '</div>';

						html += '<div class="item_menu_list" data-id="74">';
						html += '	<div class="item_menu">';
						html += '		<div class="flex-item"><div class="inner"><a href="../item/?category=75&backurl='+encodeURIComponent(window.location.pathname+'?tab='+tab+'&top='+r_top+'&middle='+r_middle+'&lat='+r_lat+'&lng='+r_lng)+'"><img src="../images/item_menu_icon_2.png"><h5 class="menu_name">응고형모래</h5></a></div></div>';
						html += '	</div>';
						html += '	<div class="item_menu">';
						html += '		<div class="flex-item"><div class="inner"><a href="../item/?category=76&backurl='+encodeURIComponent(window.location.pathname+'?tab='+tab+'&top='+r_top+'&middle='+r_middle+'&lat='+r_lat+'&lng='+r_lng)+'"><img src="../images/item_menu_icon_3.png"><h5 class="menu_name">흡수형모래</h5></a></div></div>';
						html += '	</div>';
						html += '	<div class="item_menu">';
						html += '		<div class="flex-item"><div class="inner"><a href="../item/?category=77&backurl='+encodeURIComponent(window.location.pathname+'?tab='+tab+'&top='+r_top+'&middle='+r_middle+'&lat='+r_lat+'&lng='+r_lng)+'"><img src="../images/item_menu_icon_8.png"><h5 class="menu_name">낚시대/레이져</h5></a></div></div>';
						html += '	</div>';
						html += '	<div class="item_menu">';
						html += '		<div class="flex-item"><div class="inner"><a href="../item/?category=80&backurl='+encodeURIComponent(window.location.pathname+'?tab='+tab+'&top='+r_top+'&middle='+r_middle+'&lat='+r_lat+'&lng='+r_lng)+'"><img src="../images/item_menu_icon_9.png"><h5 class="menu_name">스크래쳐/박스</h5></a></div></div>';
						html += '	</div>';
						html += '	<div class="item_menu">';
						html += '		<div class="flex-item"><div class="inner"><a href="../item/?category=92&backurl='+encodeURIComponent(window.location.pathname+'?tab='+tab+'&top='+r_top+'&middle='+r_middle+'&lat='+r_lat+'&lng='+r_lng)+'"><img src="../images/item_menu_icon_22.png"><h5 class="menu_name">캣타워/캣휠</h5></a></div></div>';
						html += '	</div>';
						html += '	<div class="item_menu">';
						html += '		<div class="flex-item"><div class="inner"><a href="../item/?category=84&backurl='+encodeURIComponent(window.location.pathname+'?tab='+tab+'&top='+r_top+'&middle='+r_middle+'&lat='+r_lat+'&lng='+r_lng)+'"><img src="../images/item_menu_icon_12.png"><h5 class="menu_name">위생용품</h5></a></div></div>';
						html += '	</div>';
						html += '	<div class="item_menu">';
						html += '		<div class="flex-item"><div class="inner"><a href="../item/?category=82&backurl='+encodeURIComponent(window.location.pathname+'?tab='+tab+'&top='+r_top+'&middle='+r_middle+'&lat='+r_lat+'&lng='+r_lng)+'"><img src="../images/item_menu_icon_6.png"><h5 class="menu_name">미용관리</h5></a></div></div>';
						html += '	</div>';
						html += '	<div class="item_menu">';
						html += '		<div class="flex-item"><div class="inner"><a href="../item/item_category_list.php?category=74&backurl='+encodeURIComponent(window.location.pathname+'?tab='+tab+'&top='+r_top+'&middle='+r_middle+'&lat='+r_lat+'&lng='+r_lng)+'"><img src="../images/item_menu_icon_more2.png"><h5 class="menu_name">+ 더보기</h5></a></div></div>';
						html += '	</div>';
						html += '</div>';
						$mainContent.append(html);
