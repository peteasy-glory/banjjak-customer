...
<div id="fixed-menu">
	<div class="fixed-menu-wrap">
		...
		<div class="center_menu">덴탈껌과 치아용품 할인전
		</div>
...
<div id="event_7">
	<div class="banner">
		<img src="../images/view_event16_1.jpg" />
	</div>
...
<script>
	var $event = $("#event");
	var event_item_list1 = ['JB-TREAT-A247','JB-TREAT-A248','JB-TREAT-A249','JB-TREAT-A250','JB-HM-A51','JB-HM-A52','JB-TREAT-A56','JB-TREAT-A55','JB-TREAT-A57','JB-TREAT-A182','JB-TREAT-A354','JB-TREAT-A352',
							'JB-TREAT-A351','JB-TREAT-A353','JB-TREAT-A162','JB-TREAT-A164','JB-TREAT-A165','JB-TREAT-A163','JB-TREAT-A117','JB-TREAT-A116','JB-TREAT-A115'];
	var event_item_list2 = ['JB-TREAT-A174','JB-TREAT-A175','JB-TREAT-A176','JB-TREAT-A177','JB-TREAT-A171','JB-TREAT-A172','JB-TREAT-A173'];
	var event_item_list3 = ['JB-T-A87','JB-T-A88','JB-T-A56','JB-T-A57','JB-T-A83','JB-T-A82','ETCB-BP-A04'];
	var event_item_list4 = ['JB-DC-A43','JB-DC-A34','JB-DC-A04','JB-DC-A42','JB-DC-A31','ETCB-BP-A05'];
	var event_item_list5 = ['JB-DC-A37','JB-DC-A38','JB-DC-A36','JB-DC-A35','JB-DC-A17','JB-DC-A18'];
	var event_item_list6 = ['JB-DC-A21','JB-DC-A05'];

	var sub_title = ['덴탈껌','덴탈껌 (대용량)','치석제거용 장난감','치약','칫솔','티슈'];
