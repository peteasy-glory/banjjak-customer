...
<div id="event_7">
	<div class="banner">
		<img src="../images/view_event13_1.jpg" />
	</div>
...
<script>
	var $event = $("#event");
	var event_item_list1 = ['JB-T-A88', 'JB-T-A87', 'JB-T-A83', 'JB-T-A82', 'JB-T-A69', 'JB-T-A68', 'JB-T-A67', 'JB-T-A66', 'JB-T-A65','JB-T-A64','JB-T-A63','JB-T-A62','JB-T-A61','JB-T-A60','JB-T-A59','JB-T-A58','JB-T-A57','JB-T-A56','JB-T-A50','JB-T-A49','JB-T-A48','JB-T-A44','JB-T-A43','JB-T-A42','JB-T-A41','JB-T-A40','JB-T-A39','JB-T-A38','JB-T-A37','JB-T-A12' ,'JB-T-A11', 'JB-TREAT-A34', 'JB-TREAT-A35', 'JB-TREAT-A36', 'JB-TREAT-A37', 'JB-TREAT-A52', 'JB-TREAT-A53', 'JB-TREAT-A54', 'JB-TREAT-A55', 'JB-TREAT-A56', 'JB-TREAT-A57', 'JB-TREAT-A115', 'JB-TREAT-A116', 'JB-TREAT-A117', 'JB-TREAT-A118', 'JB-TREAT-A119', 'JB-TREAT-A120', 'JB-TREAT-A162', 'JB-TREAT-A163', 'JB-TREAT-A164', 'JB-TREAT-A165', 'JB-TREAT-A171', 'JB-TREAT-A172', 'JB-TREAT-A173', 'JB-TREAT-A174', 'JB-TREAT-A175', 'JB-TREAT-A176', 'JB-TREAT-A177', 'JB-TREAT-A182', 'JB-TREAT-A183', 'JB-TREAT-A184', 'JB-TREAT-A185', 'JB-TREAT-A186', 'JB-TREAT-A187', 'JB-TREAT-A247', 'JB-TREAT-A248', 'JB-TREAT-A249', 'JB-TREAT-A250', 'JB-TREAT-A251', 'JB-TREAT-A252', 'JB-TREAT-A253', 'JB-TREAT-A254', 'JB-TREAT-A255', 'JB-TREAT-A256', 'JB-HM-A51', 'JB-HM-A52'];
	...
	$event.on("click", ".item_link_btn", function(){
		console.log(localStorage.getItem('windowscrolltop_event13'));
		localStorage.setItem('windowscrolltop_event13',$(window).scrollTop()); // scroll position
	...
	function get_event_item_list_html(){
		return new Promise(function(resolve, reject) {
			...
			html += '	<div class="title"><span>치아관리</span></div>';
	...
	function footer_html(){
		return new Promise(function(resolve, reject) {
			...
			*/
			...
			console.log(localStorage.getItem('windowscrolltop_event13'));
			if(localStorage.getItem('windowscrolltop_event13') > 0){
				$('html, body').animate({
					scrollTop: localStorage.getItem('windowscrolltop_event13')
				}, 500, function(){
					localStorage.setItem('windowscrolltop_event13', 0); // scroll position					
				});
			}
		});
	}
