...
<div class="top_menu">
    <div class="top_back"><a href="<?= $mainpage_directory ?>/manage_user_info_2.php"><img src="<?= $image_directory ?>/btn_back_2.png" width="26px"></a></div>
    <div class="top_title">
        <p>마이 펫 프로필 작성</p>
    </div>
</div>
...
$p_weight = "";
if ($mypet_name) {
    $pet_sql = "select * from tb_mypet where customer_id = '" . $user_id . "' and name_for_owner = '" . $mypet_name . "';";
