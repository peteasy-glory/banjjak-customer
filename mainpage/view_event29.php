...
<!-- 		<img src="../images/view_event23.jpg" /> -->
		<img src="../images/view_event29.jpg" />
	</div>
...
<script>
	var $event = $("#event");
	var event_item_list1 = ['JB-S-A106','JB-S-A104','JB-S-A105','JB-S-A107','JB-S-A109','JB-S-A108','JB-S-A116','JB-S-A118','JB-S-A117','JB-CL-C17','JB-CL-C16',
							'JB-CL-C15','JB-CL-C34','JB-CL-C33','JB-CL-C32','JB-CL-C31','JB-CL-C30','JB-CL-C29']; 
	var event_item_list2 = ['JB-S-C01','JB-S-C02','JB-S-C03','JB-S-C04','JB-S-A121','JB-S-A120'];
	var event_item_list3 = ['JB-DFL-C04','JB-DFL-C02','JB-DFL-C03','JB-DFL-C01','JB-DFL-C07','JB-DFL-C06','JB-DFL-C05'];
	var event_item_list4 = ['JB-S-A79','JB-S-A80','JB-S-A81','JB-S-A82','JB-S-A83','JB-S-A84','JB-TTA-C06'];

	var sub_title = ['응고형모래','응고형모래','흡수형모래','매트'];
