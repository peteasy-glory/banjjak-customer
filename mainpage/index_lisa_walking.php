...
<link rel="stylesheet" href="<?= $css_directory ?>/m_layout_lisa_walking.css?<?= filemtime($upload_static_directory . $css_directory . '/m_layout_lisa_walking.css') ?>">
...
<div class="mainpage_yellow">
	...
	<div class="white">
		...
		<ul>
			<li class="point">산책포인트</li>
			<li class="etc_point">기타포인트</li>
			<li class="allpoint">총 보유포인트</li>
		</ul>
		<button type="button" class="gowalk">산책하기</button>
	</div>
	<div class="banner">
		<a href="#"><img src="/pet/images/beginingdogbanner.jpg"/></a>
	</div>
	<div class="close">
...
<script>
	$('.navigation .list .walking').click(function(){
      $('.cover').fadeIn();
      $('.mainpage_yellow').animate({'top':'0%'},800);
      $('body,html').css('overflow','hidden'); //커버올라오면 메인에 스크롤바없앰
    });


    $('.close_btn').click(function(){
      $('.mainpage_yellow').animate({'top':'-80%'},800);
      $('.cover').fadeOut();
      $('body,html').css('overflow','auto'); //커버들어가면 스크롤바 다시생김
    });
</script>
...
<div class="navigation">
	<ul class="list">
		<li class="home <?=($_SERVER['PHP_SELF']=="/pet/mainpage/index_lisa_walking.php" and ($_REQUEST['tab']=="" or $_REQUEST['tab']==1))?"on":""?>"" ><a href="https://www.gopet.kr/pet/mainpage/index_lisa_walking.php?tab=1"><br><p>홈</p></a></li>
		<li class="walking"><br><br><p class="pline">산책</p></li>
		<li class="beauty <?=($_SERVER['PHP_SELF']=="/pet/mainpage/index_lisa_walking.php" and $_REQUEST['tab']==2)?"on":""?>"><a href="https://www.gopet.kr/pet/mainpage/index_lisa_walking.php?tab=2"><br><p>미용/호텔</p></a></li>
		<li class="shopping <?=($_SERVER['PHP_SELF']=="/pet/mainpage/index_lisa_walking.php" and $_REQUEST['tab']==3)?"on":""?>""><a href="https://www.gopet.kr/pet/mainpage/index_lisa_walking.php?tab=3"><br><p>쇼핑</p></a></li>
		<li class="search <?=($_SERVER['PHP_SELF']=="/pet/mainpage/search_item_lisa.php")?"on":""?>"><a href="https://www.gopet.kr/pet/mainpage/search_item_lisa.php"><br><p>검색</p></a></li>
		<li class="morebtn <?=($_SERVER['PHP_SELF']=="/pet/mainpage/mainpage_my_menu_glory.php")?"on":""?>" ><a href="https://www.gopet.kr/pet/mainpage/mainpage_my_menu_glory.php"><br><p>마이반짝</p></a></li>
	</ul>
	<!--<div>
		<ul class="text">
			<li>홈</li>
		...
		if(tab == "1"){
			...
			$("#item_select").on('change', function(){
				...
				if (selected_sort == "강아지"){
					...
					select_cat_val = '';
					<? if($_typ_os == "Android") { ?>
						location.href="https://www.gopet.kr/pet/mainpage/index_lisa.php?tab=3&selected_sort=강아지";
					<? } else { ?>
...
//						.then(no_app);
					...
					select_dog_val = '';
					<? if($_typ_os == "Android") { ?>
						location.href="https://www.gopet.kr/pet/mainpage/index_lisa.php?tab=3&selected_sort=고양이";
					<? } else { ?>
