		...
		if(tab == "1"){
			...
			$("#item_select").on('change', function(){
				...
				if (selected_sort == "강아지"){
					select_dog_val = 'selected';
					select_cat_val = '';
					location.href="https://www.gopet.kr/pet/mainpage/index.php?tab=3&selected_sort=강아지";
...
//						.then(no_app);
					...
					select_cat_val = 'selected';
					select_dog_val = '';
					location.href="https://www.gopet.kr/pet/mainpage/index.php?tab=3&selected_sort=고양이";
//					$("#fixed-menu #search_link").attr("href","<?=$mainpage_directory ?>/search_item.php?tab="+tab+"&selected_sort="+selected_sort);
//					get_customer()
//						.then(item_html_cat)
