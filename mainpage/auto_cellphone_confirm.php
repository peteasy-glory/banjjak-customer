...
<?
	...
	*****************************************************************************************/
	...
	$Siteurl		= "gopet.kr"; 		//가맹점도메인
	$Tradeid		= strval(uniqid()); 		//가맹점거래번호
	
	// $CI_SVCID		= "180424053493"; 		//서비스아이디
	$CI_SVCID		= "190123066519"; 		//서비스아이디
	$CI_Mode		= "61"; 	// 61:SMS발송, 67:SMS미발송
	
	
	$Okurl 			= "https://".$_SERVER['HTTP_HOST']."/pet/mainpage/regist_shop_auth.php";		//성공URL : 결제완료통보페이지 full Url (예:http://www.mcash.co.kr/okurl.jsp )	
